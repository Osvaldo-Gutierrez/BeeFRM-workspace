 ...
 */
public class logical_and_expression implements Node {
    private Node parent;
    public equality_expression f0;
    public NodeListOptional f1;

    public logical_and_expression(equality_expression n0, NodeListOptional n1) {
        f0 = n0;
