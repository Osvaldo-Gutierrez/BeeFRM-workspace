 ...
 */
public class additive_expression implements Node {
    private Node parent;
    public multiplicative_expression f0;
    public NodeListOptional f1;

    public additive_expression(multiplicative_expression n0, NodeListOptional n1) {
        f0 = n0;
