      ...
      *           GOBACK.                                                
           ...
           MOVE TSK-TERM-NUM-TUX    TO TSK-TERM-NUM-TUX-6
           
           MOVE 'GET'                  TO QUE-COM-SEND.                                                 
           MOVE TSK-TERM-NUM-TUX-ALF-6 TO HEADER-COD-TYPE.
           MOVE HEADER-NOM-TSPT        TO QUE-NAM-SEND.      
           MOVE 1                      TO QUE-NUM-SEND.      
           MOVE 100                    TO QUE-LAR-SEND.      
           MOVE SPACES                 TO QUE-TRX-SEND.      
           MOVE SPACES                 TO QUE-DAT-SEND.                           
           PERFORM GNS-MSJ-QUE.
           IF QUE-STAT NOT = QUE-STAT-OKS
              MOVE SPACES           TO HEADER-MENS
           ELSE           
              MOVE QUE-DAT-RECV     TO QUE-ITEM           
              MOVE QUE-DATA         TO HEADER-MENS.
