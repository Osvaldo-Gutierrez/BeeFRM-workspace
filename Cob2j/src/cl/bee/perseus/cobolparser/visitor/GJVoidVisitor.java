...
public interface GJVoidVisitor<A> {
   ...
   public void visit(NodeToken n, A argu);
     ...
     */
    public void visit(QuotedText n, A argu);
     ...
     *       | <DOUBLEDAPOSTROPHE>
     */
    public void visit(IterableQuotedText n, A argu);
     ...
     */
    public void visit(IterableNonNumericConstant n, A argu);
     ...
     */
    public void visit(IterableLiteral n, A argu);

    /**
     * f0 -> ArithmeticExpression()
     *       | <LPARENCHAR> Condition() <RPARENCHAR>
     */
    public void visit(IterableCondition n, A argu);
     ...
     */
    public void visit(FunctionClause n, A argu);
     ...
     * f0 -> CobolWord()
     */
    public void visit(ConventionName n, A argu);

    /**
     * f0 -> CobolWord()
     */
    public void visit(HandleComponent n, A argu);

    /**
     * f0 -> QuotedText()
     */
    public void visit(ImplicitTitle n, A argu);

    /**
     * f0 -> DataName()
     */
    public void visit(LevelName66 n, A argu);

    /**
     * f0 -> DataName()
     */
    public void visit(LevelName77 n, A argu);

    /**
     * f0 -> ConditionName()
     */
    public void visit(LevelName88 n, A argu);

    /**
     * f0 -> [ DataName() | <FILLER> | <REPLY> | <PROGRAM_STATUS> ]
     */
    public void visit(LevelName n, A argu);
     ...
     * f1 -> <EOF>
     */
    public void visit(CopyBookUnit n, A argu);
     ...
     */
    public void visit(IterableAlphabetPhrase n, A argu);
     ...
     * f3 -> ConventionName()
     */
    public void visit(CallConventionClause n, A argu);
     ...
     * f3 -> Identifier()
     */
    public void visit(RelativeKeyClause n, A argu);
     ...
     * f5 -> [ [ <WITH> ] <DUPLICATES> ]
     */
    public void visit(RecordKeyClause n, A argu);
     ...
     * f3 -> Literal()
     */
    public void visit(DataIdentifiedClause n, A argu);
     ...
     *       | <WINDOW>
     */
    public void visit(MemoryUsage n, A argu);
     ...
     */
    public void visit(ExternalUsage n, A argu);
     ...
     *       | <BIT>
     */
    public void visit(PropertyObjectModifier n, A argu);
     ...
     */
    public void visit(Through n, A argu);
     ...
     */
    public void visit(LinkageSectionEntry n, A argu);
     ...
     */
    public void visit(CallByContent n, A argu);
     ...
     */
    public void visit(CallByReference n, A argu);
     ...
     */
    public void visit(CallByDescriptor n, A argu);
     ...
     * f2 -> ( <ADDRESS> <OF> Identifier() | [ <LENGTH> <OF> ] Identifier() | Literal() | <OMITTED> )+
     */
    public void visit(CallByValue n, A argu);
     ...
     */
    public void visit(EvaluateWhenClause n, A argu);
     ...
     * f3 -> ArithmeticExpression()
     */
    public void visit(EvaluateThruPhrase n, A argu);
     ...
     * f0 -> <EXEC>
     */
    public void visit(ExecStatement n, A argu);
     ...
     */
    public void visit(IterableTallyingClause n, A argu);
     ...
     */
    public void visit(RecursiveTallyingClause n, A argu);
     ...
     * f1 -> ( IterableBeforeAfterPhrase() )*
     */
    public void visit(IterableBeforeAfterClause n, A argu);
     ...
     */
    public void visit(IterableBeforeAfterPhrase n, A argu);
     ...
     */
    public void visit(PerformFlavour n, A argu);
     ...
     */
    public void visit(PerformVaryingWithAfterClause n, A argu);
     ...
     */
    public void visit(PerformVaryingPhrase n, A argu);

    /**
     * f0 -> <UNTIL>
     * f1 -> Condition()
     */
    public void visit(PerformUntilClause n, A argu);
     ...
     * f2 -> ( <BEFORE> | <AFTER> )
     */
    public void visit(PerformTestPositionClause n, A argu);

    /**
     * f0 -> ProcedureName()
     * f1 -> [ ( <THROUGH> | <THRU> ) ProcedureName() ]
     */
    public void visit(PerformProcedureScopeClause n, A argu);

    /**
     * f0 -> ( Identifier() | IntegerConstant() )
     * f1 -> <TIMES>
     */
    public void visit(PerformTimeClause n, A argu);
     ...
     * f1 -> <EOF>
     */
    public void visit(DataDescription n, A argu);

    /**
     * f0 -> ( Sentence() )*
     * f1 -> <EOF>
     */
    public void visit(SentenceList n, A argu);
