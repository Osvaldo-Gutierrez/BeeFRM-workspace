 ...
 */
public class EnvironmentNameIsMnemonicNameClause implements Node {
    private Node parent;
    public EnvironmentName f0;
    public NodeChoice f1;

    public EnvironmentNameIsMnemonicNameClause(EnvironmentName n0, NodeChoice n1) {
        f0 = n0;
