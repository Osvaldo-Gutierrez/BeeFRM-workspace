 ...
 */
public class GotoStatement implements Node {
    private Node parent;
    public NodeToken f0;
    public NodeOptional f1;
    public NodeChoice f2;

    public GotoStatement(NodeToken n0, NodeOptional n1, NodeChoice n2) {
        f0 = n0;
    ...
    public GotoStatement(NodeOptional n0, NodeChoice n1) {
        f0 = new NodeToken("GO");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
