 ...
 */
public class ConfigurationSection implements Node {
    private Node parent;
    public NodeToken f0;
    public NodeToken f1;
    public NodeToken f2;
    ...
    public ConfigurationSection(NodeToken n0, NodeToken n1, NodeToken n2, NodeListOptional n3) {
        f0 = n0;
    ...
    public ConfigurationSection(NodeToken n0, NodeListOptional n1) {
        f0 = new NodeToken("CONFIGURATION");
        if ( f0 != null ) f0.setParent(this);
