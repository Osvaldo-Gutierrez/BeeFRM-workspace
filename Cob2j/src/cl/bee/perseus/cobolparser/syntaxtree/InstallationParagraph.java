 ...
 * f2 -> [ CommentLine() ]
 */
public class InstallationParagraph implements Node {
    private Node parent;
    public NodeToken f0;
    public NodeToken f1;
    public NodeOptional f2;

    public InstallationParagraph(NodeToken n0, NodeToken n1, NodeOptional n2) {
        f0 = n0;
    ...
    public InstallationParagraph(NodeToken n0, NodeOptional n1) {
        f0 = new NodeToken("INSTALLATION");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
        f2 = n1;
