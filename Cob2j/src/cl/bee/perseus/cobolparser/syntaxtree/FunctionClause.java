 ...
 */
public class FunctionClause implements Node {
    private Node parent;
    public NodeToken f0;
    ...
    public FunctionClause(NodeToken n0, FunctionName n1, NodeOptional n2, NodeOptional n3) {
        f0 = n0;
    ...
    public FunctionClause(FunctionName n0, NodeOptional n1, NodeOptional n2) {
