 ...
 * f1 -> Condition()
 */
public class PerformUntilClause implements Node {
    private Node parent;
    public NodeToken f0;
    public Condition f1;

    public PerformUntilClause(NodeToken n0, Condition n1) {
        f0 = n0;
    ...
    public PerformUntilClause(Condition n0) {
        f0 = new NodeToken("UNTIL");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
    }
