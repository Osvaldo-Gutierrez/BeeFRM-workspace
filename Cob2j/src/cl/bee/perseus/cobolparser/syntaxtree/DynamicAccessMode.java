 ...
 */
public class DynamicAccessMode implements Node {
    private Node parent;
    public NodeToken f0;
    public NodeOptional f1;

    public DynamicAccessMode(NodeToken n0, NodeOptional n1) {
        f0 = n0;
    ...
    public DynamicAccessMode(NodeOptional n0) {
        f0 = new NodeToken("DYNAMIC");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
    }
