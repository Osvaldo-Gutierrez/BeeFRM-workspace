...
public class LinkageSection implements Node {
    ...
    public NodeToken f1;
    public NodeToken f2;
    public LinkageSectionEntry f3;

    public LinkageSection(NodeToken n0, NodeToken n1, NodeToken n2, LinkageSectionEntry n3) {
        f0 = n0;
    ...
    public LinkageSection(NodeToken n0, LinkageSectionEntry n1) {
