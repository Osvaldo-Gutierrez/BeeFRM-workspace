...
public class DisplayStatement implements Node {
    ...
    public DisplayStatement(NodeToken n0, NodeChoice n1, NodeListOptional n2, NodeOptional n3, NodeOptional n4) {
        f0 = n0;
    ...
    public DisplayStatement(NodeChoice n0, NodeListOptional n1, NodeOptional n2, NodeOptional n3) {
        f0 = new NodeToken("DISPLAY");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
        f2 = n1;
