 ...
 * f2 -> [ CommentLine() ]
 */
public class CharacterSetClause implements Node {
    private Node parent;
    public NodeToken f0;
    public NodeToken f1;
    public NodeOptional f2;

    public CharacterSetClause(NodeToken n0, NodeToken n1, NodeOptional n2) {
        f0 = n0;
    ...
    public CharacterSetClause(NodeOptional n0) {
        f0 = new NodeToken("CHARACTER");
        if ( f0 != null ) f0.setParent(this);
