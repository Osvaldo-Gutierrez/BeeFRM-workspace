 ...
 * f4 -> <DOT>
 */
public class SourceComputerParagraph implements Node {
    private Node parent;
    public NodeToken f0;
    public NodeToken f1;
    ...
    public SourceComputerParagraph(NodeToken n0, ComputerName n1, NodeOptional n2, NodeToken n3) {
        f0 = new NodeToken("SOURCE-COMPUTER");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
        f2 = n1;
