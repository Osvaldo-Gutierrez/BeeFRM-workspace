 ...
 */
public class PaddingCharacterClause implements Node {
    private Node parent;
    public NodeToken f0;
    ...
    public PaddingCharacterClause(NodeToken n0, NodeOptional n1, NodeOptional n2, NodeChoice n3) {
        f0 = n0;
    ...
    public PaddingCharacterClause(NodeOptional n0, NodeOptional n1, NodeChoice n2) {
        f0 = new NodeToken("PADDING");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
        f2 = n1;
