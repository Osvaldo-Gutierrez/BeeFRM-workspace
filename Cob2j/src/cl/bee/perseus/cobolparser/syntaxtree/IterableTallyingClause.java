 ...
 */
public class IterableTallyingClause implements Node {
    private Node parent;
    public NodeToken f0;
    public NodeListOptional f1;

    public IterableTallyingClause(NodeToken n0, NodeListOptional n1) {
        f0 = n0;
    ...
    public IterableTallyingClause(NodeListOptional n0) {
        f0 = new NodeToken("CHARACTERS");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
    }
