...
public class FileStatusClause implements Node {
    ...
    public FileStatusClause(NodeOptional n0, NodeToken n1, NodeOptional n2, Identifier n3, NodeOptional n4) {
        f0 = n0;
    ...
    public FileStatusClause(NodeOptional n0, NodeOptional n1, Identifier n2, NodeOptional n3) {
        f0 = n0;
        if ( f0 != null ) f0.setParent(this);
