...
public class RelativeKeyClause implements Node {
    ...
    public RelativeKeyClause(NodeToken n0, NodeOptional n1, NodeOptional n2, Identifier n3) {
        f0 = n0;
    ...
    public RelativeKeyClause(NodeOptional n0, NodeOptional n1, Identifier n2) {
