 ...
 * f1 -> AbbreviationLeaf()
 */
public class AbbreviationRest implements Node {
    private Node parent;
    public RelationalOperator f0;
    public AbbreviationLeaf f1;

    public AbbreviationRest(RelationalOperator n0, AbbreviationLeaf n1) {
        f0 = n0;
