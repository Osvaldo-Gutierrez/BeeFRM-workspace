 ...
 * f3 -> Literal()
 */
public class DataIdentifiedClause implements Node {
    private Node parent;
    ...
    public DataIdentifiedClause(NodeOptional n0, NodeToken n1, NodeToken n2, Literal n3) {
        f0 = n0;
    ...
    public DataIdentifiedClause(NodeOptional n0, Literal n1) {
        f0 = n0;
        if ( f0 != null ) f0.setParent(this);
        f1 = new NodeToken("IDENTIFIED");
        if ( f1 != null ) f1.setParent(this);
        f2 = new NodeToken("BY");
        if ( f2 != null ) f2.setParent(this);
        f3 = n1;
