 ...
 */
public class RandomAccessMode implements Node {
    private Node parent;
    public NodeToken f0;
    public NodeOptional f1;

    public RandomAccessMode(NodeToken n0, NodeOptional n1) {
        f0 = n0;
    ...
    public RandomAccessMode(NodeOptional n0) {
        f0 = new NodeToken("RANDOM");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
    }
