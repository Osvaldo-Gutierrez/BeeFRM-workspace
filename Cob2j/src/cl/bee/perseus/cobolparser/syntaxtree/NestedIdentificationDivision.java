 ...
 */
public class NestedIdentificationDivision implements Node {
    private Node parent;
    public NodeChoice f0;
    public NodeToken f1;
    public NodeToken f2;
    public NestedProgramIdParagraph f3;
    ...
    public NestedIdentificationDivision(NodeChoice n0, NodeToken n1, NestedProgramIdParagraph n2, NodeListOptional n3) {
        f0 = n0;
        if ( f0 != null ) f0.setParent(this);
