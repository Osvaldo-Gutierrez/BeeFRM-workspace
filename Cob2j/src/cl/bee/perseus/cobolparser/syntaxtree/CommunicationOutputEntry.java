 ...
 */
public class CommunicationOutputEntry implements Node {
    private Node parent;
    public NodeToken f0;
    public CdName f1;
    ...
    public CommunicationOutputEntry(CdName n0, NodeOptional n1, NodeListOptional n2) {
        f0 = new NodeToken("CD");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
