 ...
 * f2 -> [ <FROM> Identifier() ]
 */
public class ReleaseStatement implements Node {
    private Node parent;
    public NodeToken f0;
    public RecordName f1;
    public NodeOptional f2;

    public ReleaseStatement(NodeToken n0, RecordName n1, NodeOptional n2) {
        f0 = n0;
    ...
    public ReleaseStatement(RecordName n0, NodeOptional n1) {
        f0 = new NodeToken("RELEASE");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
        f2 = n1;
