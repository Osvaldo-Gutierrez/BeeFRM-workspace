 ...
 */
public class PerformVaryingWithAfterClause implements Node {
    private Node parent;
    public NodeToken f0;
    public PerformVaryingPhrase f1;
    public NodeListOptional f2;

    public PerformVaryingWithAfterClause(NodeToken n0, PerformVaryingPhrase n1, NodeListOptional n2) {
        f0 = n0;
    ...
    public PerformVaryingWithAfterClause(PerformVaryingPhrase n0, NodeListOptional n1) {
