 ...
 * f6 -> ( DataName() )*
 */
public class CommunicationInputEntry implements Node {
    private Node parent;
    public NodeToken f0;
    public CdName f1;
    ...
    public CommunicationInputEntry(CdName n0, NodeOptional n1, NodeOptional n2, NodeListOptional n3, NodeListOptional n4) {
        f0 = new NodeToken("CD");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
