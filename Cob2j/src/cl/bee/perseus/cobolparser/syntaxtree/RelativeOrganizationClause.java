 ...
 * f1 -> [ Identifier() ]
 */
public class RelativeOrganizationClause implements Node {
    private Node parent;
    public NodeToken f0;
    public NodeOptional f1;

    public RelativeOrganizationClause(NodeToken n0, NodeOptional n1) {
        f0 = n0;
    ...
    public RelativeOrganizationClause(NodeOptional n0) {
