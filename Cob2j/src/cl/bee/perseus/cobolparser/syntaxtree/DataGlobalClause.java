 ...
 * f1 -> <GLOBAL>
 */
public class DataGlobalClause implements Node {
    private Node parent;
    public NodeOptional f0;
    public NodeToken f1;

    public DataGlobalClause(NodeOptional n0, NodeToken n1) {
        f0 = n0;
    ...
    public DataGlobalClause(NodeOptional n0) {
        f0 = n0;
        if ( f0 != null ) f0.setParent(this);
        f1 = new NodeToken("GLOBAL");
        if ( f1 != null ) f1.setParent(this);
    }
