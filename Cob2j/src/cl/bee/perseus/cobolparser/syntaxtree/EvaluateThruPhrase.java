 ...
 */
public class EvaluateThruPhrase implements Node {
    private Node parent;
    public NodeOptional f0;
    public ArithmeticExpression f1;
    public NodeChoice f2;
    public ArithmeticExpression f3;

    public EvaluateThruPhrase(NodeOptional n0, ArithmeticExpression n1, NodeChoice n2, ArithmeticExpression n3) {
        f0 = n0;
