 ...
 * f1 -> <EOF>
 */
public class CopyBookUnit implements Node {
    private Node parent;
    public LinkageSectionEntry f0;
    public NodeToken f1;

    public CopyBookUnit(LinkageSectionEntry n0, NodeToken n1) {
        f0 = n0;
    ...
    public CopyBookUnit(LinkageSectionEntry n0) {
        f0 = n0;
        if ( f0 != null ) f0.setParent(this);
        f1 = new NodeToken("");
        if ( f1 != null ) f1.setParent(this);
