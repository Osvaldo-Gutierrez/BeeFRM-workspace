 ...
 */
public class DataRedefinesClause implements Node {
    private Node parent;
    public NodeToken f0;
    public DataName f1;
    public NodeOptional f2;

    public DataRedefinesClause(NodeToken n0, DataName n1, NodeOptional n2) {
        f0 = n0;
    ...
    public DataRedefinesClause(DataName n0, NodeOptional n1) {
        f0 = new NodeToken("REDEFINES");
        if ( f0 != null ) f0.setParent(this);
        f1 = n0;
        if ( f1 != null ) f1.setParent(this);
        f2 = n1;
